...
class Solution:
    ...
    def candy(self, ratings):
        cur = 1
        ans_arr = [1] * len(ratings)
        for i in xrange(1, len(ratings)):
            if ratings[i] > ratings[i-1] and ans_arr[i] <= ans_arr[i-1]:
